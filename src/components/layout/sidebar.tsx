...
export function Sidebar({
  ...
  return (
    <TooltipProvider delayDuration={0}>
      ...
      <aside
        className={cn(
          "dark z-30 flex h-dvh flex-col border-r border-sidebar-border bg-sidebar transition-all duration-300",
          "fixed left-0 top-0",
          "md:static",
                  ...
                  {visibleItems.map((item) => {
                    ...
                    const linkContent = (
                      ...
                      >
                        ...
                        {isActive && (
                          <div className="absolute left-0 top-1/2 h-5 w-1 -translate-y-1/2 rounded-r-full bg-sidebar-primary shadow-[0_0_8px_rgba(22,163,74,0.3)]" />
                        )}
