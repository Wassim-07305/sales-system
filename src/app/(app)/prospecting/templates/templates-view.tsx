...
export function TemplatesView({ templates }: { templates: Template[] }) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Templates de DM"
        description="Gérez vos templates de prospection"
      >
          ...
          <div className="flex items-center justify-center gap-2 flex-wrap">
            {stepCounts.map((s, i) => (
              <div key={s.step} className="flex items-center gap-2">
                <button
                  onClick={() =>
                    setFilterStep(filterStep === s.step ? "all" : s.step)
                  }
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {filtered.map((t) => (
          <Card
            key={t.id}
            className="shadow-sm rounded-2xl hover:shadow-md transition-shadow"
          >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                ...
                <Select
                  value={form.step}
                  onValueChange={(v) => setForm({ ...form, step: v })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={6}
                placeholder="Variables: {{prenom}}, {{niche}}, {{pain_point}}..."
              />
            </div>
            <Button
              onClick={handleSave}
