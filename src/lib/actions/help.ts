...
const ARTICLES: HelpArticle[] = [
  // ── Démarrage ───────────────────────────────────────────────────────
  {
    ...
    excerpt:
      "Apprenez à créer votre compte et à configurer votre profil en quelques minutes.",
...
<p>Vous pouvez réorganiser les widgets selon vos préférences et masquer ceux qui ne sont pas pertinents pour votre activité quotidienne. Les données se rafraîchissent automatiquement toutes les 5 minutes.</p>`,
  ...
  },
  {
    ...
    categoryName: "Démarrage",
    excerpt:
      "Découvrez la sidebar, la navigation mobile et les raccourcis clavier.",
...
<p>Les administrateurs peuvent ajouter, renommer ou réorganiser les étapes du pipeline depuis les paramètres. Chaque étape possède une couleur personnalisable pour faciliter la lecture visuelle du tableau.</p>`,
  ...
  },
  {
    ...
    categoryName: "CRM & Pipeline",
    excerpt:
      "Ajoutez un nouveau deal et renseignez les informations clés pour le qualifier.",
...
<p>Une fois l'import terminé, un rapport récapitulatif indique le nombre de contacts créés, mis à jour et ignorés. Les contacts importés sont immédiatement disponibles dans le CRM et peuvent être associés à des deals.</p>`,
  ...
  // ── Prospection ─────────────────────────────────────────────────────
  {
    ...
    excerpt:
      "Centralisez toutes vos actions de prospection depuis le hub dédié.",
...
<p>Le tableau de suivi affiche l'état de chaque facture : en attente, payée, en retard ou annulée. Des relances automatiques peuvent être configurées pour les factures en retard.</p>`,
  ...
  },
  {
    ...
    categoryName: "Contrats",
    excerpt:
      "Créez des modèles réutilisables pour accélérer la rédaction de vos contrats.",
...
<p>La plateforme génère des recommandations automatiques basées sur votre funnel : suggestions d'amélioration des scripts, identification des étapes les plus longues et comparaison avec les moyennes de l'équipe.</p>`,
  ...
  },
  {
    ...
    categoryName: "Analytics",
    excerpt:
      "Utilisez les projections pour anticiper votre chiffre d'affaires.",
...
<p>Le système comporte 5 niveaux : Débutant (0 pts), Confirmé (500 pts), Senior (1 500 pts), Élite (3 500 pts) et Légende (7 000 pts). Chaque niveau débloque des badges et une reconnaissance dans le leaderboard d'équipe.</p>`,
  ...
  },
  {
    ...
    categoryName: "Gamification",
    excerpt:
      "Relevez des défis pour booster votre motivation et vos performances.",
...
<p>Les défis d'équipe encouragent la collaboration : « L'équipe doit atteindre 50 000 € de CA ce mois ». Tous les membres contribuent et la progression est visible en temps réel. La récompense est partagée entre tous les participants.</p>`,
  ...
  },
  {
    ...
    categoryName: "Gamification",
    excerpt:
      "Comparez-vous à vos collègues et maintenez votre série d'activité.",
...
<p>Les managers peuvent envoyer des messages de diffusion à toute l'équipe ou à un groupe spécifique. Les sessions de formation vidéo sont enregistrées et disponibles en replay dans la section dédiée.</p>`,
  ...
  },
  {
    ...
    categoryName: "Communication",
    excerpt:
      "Connectez votre numéro WhatsApp pour communiquer avec vos prospects.",
...
const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      "Cliquez sur « Mot de passe oublié » sur la page de connexion. Un e-mail de réinitialisation sera envoyé à votre adresse. Suivez le lien pour définir un nouveau mot de passe. Le lien est valable 1 heure.",
  },
  {
    id: "faq-02",
    question: "Puis-je utiliser la plateforme sur mobile ?",
    answer:
      "Oui, la plateforme est une Progressive Web App (PWA). Vous pouvez l'ajouter à votre écran d'accueil depuis votre navigateur mobile pour une expérience native. La navigation mobile est optimisée avec une barre inférieure.",
  },
  {
    id: "faq-03",
    question: "Comment changer mon rôle (setter, closer, manager) ?",
    answer:
      "Seul un administrateur peut modifier les rôles. Contactez votre manager ou admin qui pourra ajuster votre rôle depuis la section Équipe > Gestion des membres.",
  },
  {
    id: "faq-04",
    question: "Les données sont-elles sécurisées ?",
    answer:
      "Oui, toutes les données sont stockées sur Supabase avec chiffrement au repos et en transit. L'accès est protégé par Row Level Security (RLS) : chaque utilisateur ne voit que les données autorisées pour son rôle. La plateforme est conforme RGPD.",
  },
  {
    id: "faq-05",
    question: "Comment exporter mes données ?",
    answer:
      "Depuis chaque section (Contacts, Deals, Analytics), utilisez le bouton d'export pour télécharger vos données au format CSV ou PDF. Les rapports Analytics peuvent également être programmés en envoi automatique par e-mail.",
  },
  {
    id: "faq-06",
    question: "Combien de membres puis-je ajouter à mon équipe ?",
    answer:
      "Le nombre de membres dépend de votre forfait. Le forfait Starter permet jusqu'à 5 membres, le Pro jusqu'à 20 et l'Enterprise est illimité. Consultez la page Abonnement dans les paramètres pour connaître votre forfait actuel.",
  },
  {
    id: "faq-07",
    question: "Comment fonctionne la page de booking publique ?",
    answer:
      "Chaque membre dispose d'une URL unique de booking (ex : /book/votre-slug). Partagez ce lien avec vos prospects pour qu'ils réservent un créneau directement dans votre agenda. Les disponibilités sont synchronisées automatiquement.",
  },
  {
    id: "faq-08",
    question: "Puis-je personnaliser les étapes du pipeline ?",
    answer:
      "Oui, les administrateurs peuvent ajouter, supprimer et réorganiser les étapes du pipeline depuis les paramètres du CRM. Chaque étape possède un nom et une couleur personnalisables.",
  },
  {
    id: "faq-09",
    question: "Comment fonctionne le système de streak ?",
    answer:
      "Un streak est une série de jours consécutifs d'activité. Chaque jour où vous atteignez votre quota minimum (configurable), votre streak augmente de 1. Un streak actif augmente votre multiplicateur de points. Manquer un jour remet le compteur à zéro.",
  },
  {
    id: "faq-10",
    question: "Comment contacter le support technique ?",
    answer:
      "Utilisez le formulaire de contact en bas de cette page ou envoyez un e-mail à support@sales-system.fr. Notre équipe répond sous 24 heures ouvrées. Les forfaits Enterprise bénéficient d'un support prioritaire par chat en direct.",
  },
  {
    id: "faq-11",
    question: "Qu'est-ce que le mode Role-Play ?",
    answer:
      "Le Role-Play est un outil d'entraînement où vous simulez des appels de vente avec un partenaire ou une IA. Après chaque session, un debrief analyse votre performance : argumentation, gestion des objections, taux de closing simulé.",
  },
  {
    id: "faq-12",
    question: "Comment fonctionnent les séquences automatiques ?",
    answer:
      "Les séquences sont des suites de messages programmés envoyés automatiquement à vos prospects. Vous définissez le contenu, les délais entre chaque message et les conditions d'arrêt (réponse, booking, désabonnement). Elles sont disponibles pour l'e-mail et WhatsApp.",
  },
  {
    id: "faq-13",
    question: "Puis-je intégrer d'autres outils ?",
    answer:
      "La Marketplace propose des extensions et intégrations partenaires. Vous pouvez également utiliser les webhooks et l'API pour connecter vos outils existants (Calendly, Stripe, Slack, etc.).",
  },
];
