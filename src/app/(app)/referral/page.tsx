...
import { getOrCreateAffiliate, getReferrals, getReferralStats } from "@/lib/actions/referral";
...
export default async function ReferralPage() {
  ...
  return <ReferralView affiliate={affiliate} referrals={referrals} stats={stats} />;
}
