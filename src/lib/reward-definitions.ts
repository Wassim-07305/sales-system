...
export const REWARDS_CATALOG: Reward[] = [
  {
    ...
    description: "Une carte cadeau de 50\u00a0\u20ac utilisable chez nos partenaires.",
    pointsCost: 500,
    icon: "CreditCard",
  },
  {
    ...
    description: "Une journ\u00e9e de cong\u00e9 suppl\u00e9mentaire \u00e0 utiliser quand vous le souhaitez.",
    pointsCost: 1000,
    icon: "Calendar",
  },
  {
  ...
  },
  {
    ...
    description: "Acc\u00e8s \u00e0 une formation premium de votre choix (valeur 500\u00a0\u20ac).",
    pointsCost: 3000,
    icon: "GraduationCap",
  },
  {
