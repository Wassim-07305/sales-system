...
export function B2BSettingsView({ userEmail }: B2BSettingsViewProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <PageHeader
        title="Paramètres"
        description="Gérez vos préférences et votre compte entreprise"
      />
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between rounded-lg border border-border p-4">
            <div>
              <p className="font-medium">Plan B2B</p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configurez vos outils d&apos;intelligence artificielle
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between rounded-lg border border-border p-4">
            <div>
              <p className="font-medium">Modes IA</p>
              <p className="text-sm text-muted-foreground">
                Assistant vocal, coaching IA, analyse de scripts
              </p>
            </div>
            <Button
              size="sm"
              variant="outline"
              onClick={() => router.push("/settings/ai-modes")}
            >
              Configurer
